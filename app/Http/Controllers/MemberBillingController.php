...
class MemberBillingController extends Controller
{
    ...
    public function check_access($detail = null)
    {
        if (in_array(session('user_menu'), ['service_unit', 'finance'])) {
            return true;
        }
    ...
    public function insert_detail_gjle($id_glje, $id_transactions)
    {
        try {
            $value_coa                 = 0;
    ...
    public function glje_content_by_id($id)
    {
