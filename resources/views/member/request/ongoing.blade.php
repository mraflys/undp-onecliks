...
<div class="modal fade" id="ratingModal" tabindex="-1" role="dialog" aria-labelledby="formReturnLabel" aria-hidden="true">
          ...
          <table class="table table-striped table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left;"><div id="rateAgency"></div></td>
              </tr>
              <tr>
                <td style="text-align: right;">Service</td>
                <td style="text-align: left;"><div id="rateService"></div></td>
              </tr>
              <tr>
                <td style="text-align: right;">Delay</td>
                <td style="text-align: left;"><div id="rateDelay"></div> Day(s)</td>
              </tr>
              <tr>
                ...
                <td style="text-align: left;">
                  <div class="rate-selector">
                    <label>
                      ...
                      <img src="<?=asset('assets/images/smiley/1.png');?>" title='Very Unsatisfied'/>
                    </label>
                    <label>
                      <input type="radio" name="rating" value="2" />
                      <img src="<?=asset('assets/images/smiley/2.png');?>" title='Unsatisfied'/>
                    </label>
                    <label>
                    ...
                    <label>
                      ...
                      <img src="<?=asset('assets/images/smiley/5.png');?>" title='Very Satisfied'/>
                    </label>
                  </div>
                </td>
              </tr>
  ...
  //   }
    ...
    function showTable(){
      ...
      var oTable = $('#mytable').DataTable({
        ...
        "columns": [
          { data: 'agency_name_service', name: 'agency_name_service' },
          { data: 'agency_name_service', name: 'agency_name_service' },
          { data: 'country_name', name: 'country_name' },
          { data: 'parent_agency_name', name: 'agency_unit_name' },
          { data: 'transaction_code', name: 'transaction_code' },
          { data: 'date_authorized', name: 'date_authorized' },
          { data: 'person_name_buyer', name: 'person_name_buyer' },
          { data: 'id_project', name: 'id_project' },
