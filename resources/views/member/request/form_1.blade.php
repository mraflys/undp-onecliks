...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <div class="col-md-9 col-xs-12">
            ...
            <form class="kt-form" action=" {{ $url }}" method="POST" id="myForm" enctype="multipart/form-data">
                ...
                <p class="text-right">
                    <br>
                    <button type="submit" class="btn btn-warning" name="submit" value="dr_service"> Send to Draft
                    </button>
                </p>
                ...
                <div class="kt-portlet__body">
                    ...
                    <div id="step1">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" required name="agency" id="agency"
                                <?= $has_detail ? 'disabled' : '' ?>>
                                <option>-- Select provider --</option>
                                @foreach ($agencies as $agency)
                                    <option value="<?= $agency->id_agency_unit ?>"
                                        <?= $agency->id_agency_unit == $id_agency_unit ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" required id="agency_unit" name="id_agency_unit_service"
                                <?= $has_detail ? 'disabled' : '' ?>></select>
                            @if ($has_detail)
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" required id="id_service" name="id_service"
                                <?= $has_detail ? 'disabled' : '' ?>></select>
                            @if ($has_detail)
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="supervisor_mail" class="form-control" required id="supervisor_mail"
                                value="<?= !empty(old('supervisor_mail')) ? old('supervisor_mail') : $supervisor_mail ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleSelect1">Unit Price</label>
                            <br />
                            <input type="hidden" name="id_currency" class="form-control" required id="id_currency"
                                value="{{ $id_currency }}">
                            <input type="text" name="currency" class="" id="currency" style="width: 90px"
                                readonly="readonly" value="{{ $currency_code }}">
                            <input type="number" name="service_price" class="" id="service_price"
                                style="width: 150px" readonly="readonly" value="{{ $service_price }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleSelect1">Qty</label>
                            <input type="number" name="qty" class="form-control" required id="qty"
                                value="<?= !empty(old('qty')) ? old('qty') : $qty ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleSelect1">Total Price</label>
                            <input type="number" name="total_price" class="form-control" required id="total_price"
                                readonly="readonly" value="{{ $service_price }}">
                        </div>
                        {{-- <div class="form-group">
          ...
          <input type="radio" name="all_notif_email" value="0" <?= $all_notif_email == 0 ? 'checked' : '' ?>> No &nbsp;
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" required name="payment_method" id="payment_method">
                                ...
                                @foreach ($payment_methods as $key => $val)
                                    <option value="{{ $key }}" <?= $key == $payment_method ? 'selected' : '' ?>>
                                        {{ $val }}</option>
                                @endforeach
                            </select>
                            <p>&nbsp;</p>
                                ...
                                <table width="90%">
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <button type="button" id="btnSearchProject" class="btn btn-success"
                                                onclick="searchCoa()">
                            ...
                            <div id="non_atlas">
                                <div class="pb-3" style="overflow-x : scroll;">
                                    ...
                                    <button type="button" onclick="addRowNonAtlas()" class="btn btn-primary"><i
                                            class="fa fa-plus"></i> Add FA</button>
                                </div>
                            </div>
                            <div id="cash">
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-12 text-right">
                                <button type="button" class="btn btn-default" onclick="goToStep(2)" id="btnStep2">
                                    Continue >></button>
                    ...
                    <div class="form-group" id="step2">
                        <div class="col-lg-12">
                            <div class="col-sm-10">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>
                                            <div id="selected_service_provider"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Service</td>
                                        <td>
                                            <div class="selected_service"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Quantity</td>
                                        <td>
                                            <div class="selected_price"></div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <table class="table">
                                    <tr>
                                        <td align="left"><button type="button" class="btn btn-default"
                                                onclick="goToStep(1)">
                                                << Previous </button>
                                        </td>
                                        <td align="right"><button type="button" class="btn btn-default"
                                                onclick="goToStep(3)"> Continue >></button></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <table class="table">
                                <tr>
                                    <td>Agency</td>
                                    <td>
                                        <div id="selected_agency"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Request Date</td>
                                    <td>
                                        <div id="selected_date"> {{ date('d-M-Y') }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Service</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selected_spv"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Unit Price</td>
                                    <td>
                                        <div id="selected_unit_price"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Qty</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selected_payment_method"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Required Info</td>
                                    <td>
                                        <div id="selected_required_info"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Required Doc</td>
                                    <td>
                                        <div id="selected_required_doc"></div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table">
                                <tr>
                                    <td colspan="2">
                                        <input type="checkbox" name="tnc_confirmation" id="tncConfirmation"
                                            value="1"> I already read and accept terms and conditions.
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        ...
                                        @if (
                                            !$has_detail ||
                                                $route_name == 'myrequests.draft_edit' ||
                                                ($has_detail && $route_name == 'myrequests.edit' && $detail->status < 2))
                                            <button type="submit" class="btn btn-primary" name="submit"
                                                value="tr_service" id="btnSave"> Send My Request </button>
                                        @endif
                                    </td>
                                </tr>
                            </table>
    ...
    <script type="text/javascript">
        ...
        function searchCoa() {
            ...
            $.ajax({
                url: "{{ URL::to('member-area/coa/search_by_project') }}" + '/' + project + '?donor=' + donor +
                    '&activity=' + activity,
                type: 'GET',
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(data) {
                    $("#loadingProject").html(
                        "<?= \App\GeneralHelper::message_dismissable('success', 'Project have been added') ?>"
                    )
                    var tRow = "";
                    var exptype = "<option value=''>-- Select Expenditure Type --</option>";
                    var countAtlas = 0;
                    $.each(data.exp_type, function(a, b) {
                        exptype += "<option value=" + b.id_exptype + ">" + b.exp_type_code + " - " + b
                            .exp_type_name + "</option>"
                    })
                    $.each(data.data, function(k, v) {
                        tRow += "<tr id='rowAtlas" + v.id_master_coa + "" + countAtlas + "'>";
                        tRow += "<td><button type='button' onclick='deleteTableRow(\"rowAtlas" + v
                            .id_master_coa + "" + countAtlas +
                            "\")'><i class='fa fa-trash'></i></button></td>";
                        tRow += "<td>" + v.fund + "</td>";
                        tRow += "<td>" + v.opu + "</td>";
                        tRow += "<td>" + v.imp_agent + "</td>";
                        tRow += "<td>" + v.donor + "</td>";
                        tRow += "<td><input type='text' name='atlas_depts[" + v.id_master_coa +
                            "]' style='width: 95px'></td>";
                        tRow += "<td>" + v.pcbu + "</td>";
                        tRow += "<td>" + v.project + "</td>";
                        tRow += "<td>" + v.activities + "</td>";
                        tRow += "<td><input type='text' name='atlas_contract_num[" + v.id_master_coa +
                            "]' style='width: 95px'></td>";
                        tRow += "<td><select name='atlas_exp_type[" + v.id_master_coa +
                            "]' class='form-control'>" + exptype + "</select></td>";
                        tRow += "<td><input type='text' name='atlas_funding_source[" + v.id_master_coa +
                            "]' style='width: 95px'></td>";
                        tRow += "<td><input type='text' name='atlas_percents[" + v.id_master_coa +
                            "]' style='width: 95px' class='percentage_fields'></td>";
                        tRow += "</tr>";
                        countAtlas++;
                    });
        ...
        function addRowNonAtlas() {
            ...
            tRowNA += "<td><button type='button' onclick='deleteTableRow(\"rowNonAtlas" + tRowNAId +
                "\")'><i class='fa fa-trash'></i></button></td>";
            ...
            tRowNA +=
                "<td><input type='text' name='non_atlas_percents[]' style='width: 100%' class='percentage_fields'></td>";
            tRowNA += "<td><input type='file' class='required-field-coa' id='non_atlas_files_" + countarrcoanonatlas +
                "' name='non_atlas_files[]' style='width: 210px'></td>";
            tRowNA += "</tr>";
        ...
        function serviceList(idCountry, idParent) {
            ...
            $.ajax({
                url: "<?= route('api-list-service-list-search-by') ?>" +
                    "?parent_only=1&with_price=true&id_parent=" + idParent,
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    $.each(data.data, function(k, value) {
                        ...
                        $("#id_service").append("<option value='" + value.id_service + "' " + selected +
                ...
                success: function(data) {
                    ...
                    $.each(data.data, function(k, value) {
                        selected = value.id_agency_unit == <?= $id_agency_unit_service ?> ? 'selected' :
                            '';
                        $("#agency_unit").append("<option value='" + value.id_agency_unit + "' " +
                            selected + ">" + value.agency_unit_name + "</option>");
                    });
            ...
            if (step == 1) {
                ...
                if (payment_method != 'transfer_cash' && payment_method != "" && (sum != 100 || isNaN(sum))) {
                    $("#messageAreaStep1").html(
                        "<br><p class='alert alert-danger text-center'>Percentage of this payment method must be 100%</p>"
                    );
                    return false;
                } else {
                    $("#messageAreaStep1").html("");
        ...
        $(function() {
            ...
            $("#txtProject").on("change", function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        const uniqueactivities = [...new Set(data.data.map(item => item
                            .activities))];
                        ...
                        var optiondonor = $("<option></option>").attr("value", "").text(
                            'select by donor');
                        txtDonor.append(optiondonor);
                        var optionactivity = $("<option></option>").attr("value", "").text(
                            'select by Activity');
                        txtActivity.append(optionactivity);

                        uniquedonor.forEach(function(donor) {
                            optiondonor = $("<option></option>").attr("value", donor)
                                .text(donor);
                            txtDonor.append(optiondonor);
                        });
                        uniqueactivities.forEach(function(donor) {
                            optionactivity = $("<option></option>").attr("value", donor)
                                .text(donor);
                            txtActivity.append(optionactivity);
                        });
                    }
            ...
            $("#id_service").change(function() {
                ...
                $.ajax({
                    url: "{{ URL::to('member-area/service_list/show_as_json') }}" + '/' +
                        idService,
                    type: 'GET',
                    dataType: 'json',
                    beforeSend: function() {
                    ...
                    success: function(data) {
                        ...
                        if (serviceData && serviceData.active_price != null) {
                            ...
                            $("#id_currency").val(serviceData.active_price.currency
                                .id_currency);

                            $("#selected_service_provider").html($("#agency option:selected")
                                .text());
                            $("#selected_service").html($("#id_service option:selected")
                                .text());
                            ...
                            if (serviceData.required_docs != null) {
                                var htmlDoc =
                                    "<table class='table table-striped table-bordered'><tr><td>Seq</td><td>Document</td><td>Note</td><td>File</td></tr>";
                                var htmlDoc2 =
                                    "<table class='table table-striped table-bordered'><tr><td>Seq</td><td>Document</td><td>Note</td><td>Docs Name</td></tr>";
                                var count = 1;
                            ...
                            if (serviceData.required_infos != null) {
                                var htmlInfo =
                                    "<table class='table table-striped table-bordered'><tr><td>Seq</td><td>Information</td><td>Description</td><td>Info Value</td></tr>";
                                var htmlInfo2 =
                                    "<table class='table table-striped table-bordered'><tr><td>Seq</td><td>Information</td><td>Description</td><td>Value</td></tr>";
                                var count = 1;
                                $.each(serviceData.required_infos, function(i, v) {
                                    ...
                                    htmlInfo += "<td>" + v.description +
                                        "</td><td><input type='text' name='required_infos[" +
                            ...
                            if (serviceData.group_workflows != null && serviceData
                                .group_workflows.length > 0) {
                                ...
                                $.each(serviceData.group_workflows, function(i, v) {
                                    id_service = v.id;
                                    tbodyWorkflows += "<tr><td colspan='6'>" + v.name +
                                        "</td></tr>";
                                    var subServiceCount = 1;
                                    $.each(v.sub_services, function(i2, v2) {
                                        tbodyWorkflows +=
                                            "<tr><td align='center'>" + v2
                                            .sequence;
                                        tbodyWorkflows +=
                                            "<input type='hidden' name='workflows[" +
                                            v2.id_service_workflow + "]'";
                                        var workflowPrice = (parseFloat(v2
                                            .price) > 0) ? parseFloat(v2
                                            .price) : 0;
                                        tbodyWorkflows += "value='" +
                                            workflowPrice + "'></td>";
                                        tbodyWorkflows += "<td>" + v2.name +
                                            "</td><td>" + v2.workflow_day +
                                            "</td><td>" + v2.agency + "</td>";
                                        if (subServiceCount == 1) {

                                            tbodyWorkflows +=
                                                "<td style='vertical-align: middle' rowspan='" +
                                                v.sub_services.length +
                                                "'><input type='checkbox' class='checkbox_price' id='checkboxprice" +
                                                checkCount +
                                                "' name='checkbox_price_input[" +
                                                id_service +
                                                "]' checked onclick='testingcheckbox(this.id)' value='" +
                                                (v2.price == null ? '-' : v2
                                                    .price) +
                                                "'><label for='checkboxprice" +
                                                checkCount +
                                                "'></label> <br> " + (v2
                                                    .price == null ? '-' : v2
                                                    .price) + "</td>";
                            ...
                            swal.fire("WARNING",
                                "Sorry, Service doesn't have Active Price. Please, Contact Admin",
                                'error');
                        }
                    },
                        ...
                        @foreach ($detail->payments() as $payment)
                            ...
                            @foreach ($exptype as $exp)
                                @if ($payment->id_exptype == $exp->id_exptype)
                                    select = "selected";
                                @endif
                                exptype += "<option value='<?= $exp->id_exptype ?>' " + select +
                                    "><?= $exp->exp_type_code ?> - <?= $exp->exp_type_name ?></option>";
                                select = "";
                            @endforeach
                            tRow += "<tr id='rowAtlas<?= $payment->id_master_coa ?>" + countAtlas + "'>";
                            tRow +=
                                "<td><button type='button' onclick='deleteTableRow(\"rowAtlas<?= $payment->id_master_coa ?>" +
                                countAtlas + "\")'><i class='fa fa-trash'></i></button></td>";
                            tRow += "<td><?= $payment->fund ?></td>";
                            tRow += "<td><?= $payment->opu ?></td>";
                            tRow += "<td><?= $payment->imp_agent ?></td>";
                            tRow += "<td><?= $payment->donor ?></td>";
                            tRow +=
                                "<td><input type='text' name='atlas_depts[<?= $payment->id_master_coa ?>]' style='width: 95px' value='<?= $payment->dept ?>'></td>";
                            tRow += "<td><?= $payment->pcbu ?></td>";
                            tRow += "<td><?= $payment->project ?></td>";
                            tRow += "<td><?= $payment->activities ?></td>";
                            tRow +=
                                "<td><input type='text' name='atlas_contract_num[<?= $payment->id_master_coa ?>]' style='width: 95px' value='<?= $payment->contract_number ?>'></td>";
                            tRow +=
                                "<td><select name='atlas_exp_type[<?= $payment->id_master_coa ?>]' class='form-control'>" +
                                exptype + "</select></td>";
                            tRow +=
                                "<td><input type='text' name='atlas_funding_source[<?= $payment->id_master_coa ?>]' style='width: 95px' value='<?= $payment->funding_source ?>'></td>";
                            tRow +=
                                "<td><input type='number' name='atlas_percents[<?= $payment->id_master_coa ?>]' style='width: 95px' value='<?= $payment->percentage ?>' class='percentage_fields'></td>";
                            tRow += "</tr>";
                            countAtlas++;
                        @endforeach
                    @endif
                    ...
                    @if ($has_detail)
                        @foreach ($detail->payments() as $payment)
                            ...
                            tRowNA += "<td><button type='button' onclick='deleteTableRow(\"rowNonAtlas" + tRowNAId +
                                "\")'><i class='fa fa-trash'></i></button></td>";
                            tRowNA +=
                                "<td><input type='text' name='non_atlas_ulos[]' style='width: 95px' value='<?= $payment->ulo ?>'></td>";
                            tRowNA +=
                                "<td><input type='text' name='non_atlas_arns[]' style='width: 95px' value='<?= $payment->arn ?>'></td>";
                            tRowNA +=
                                "<td><input type='text' name='non_atlas_projects[]' style='width: 95px' value='<?= $payment->project_no ?>'></td>";
                            tRowNA +=
                                "<td><input type='text' name='non_atlas_percents[]' style='width: 95px' value='<?= $payment->percentage ?>' class='percentage_fields'></td>";
                            tRowNA +=
                                "<td id='non_atlas_files_<?= $payment->ulo ?>_<?= $payment->arn ?>_<?= $payment->project_no ?>'><input type='file' name='non_atlas_files[]' id='non_atlas_files_" +
                                countarrcoanonatlas + "' class='required-field-coa' style='width: 95px'></td>";
                            tRowNA += "</tr>";
                        @endforeach
                    @endif
                    $("#table_non_atlas tbody").append(tRowNA);
