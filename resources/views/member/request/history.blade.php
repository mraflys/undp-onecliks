...
<script type="text/javascript">
   function showTable(){
      ...
      var oTable = $('#mytable').DataTable({
        ...
        "columns": [
          { data: 'agency_name_service', name: 'parent_agency_name' },
          { data: 'agency_name_service', name: 'parent_agency_name' },
          { data: 'country_name', name: 'ms_country.country_name' },
          { data: 'parent_agency_name', name: 'agency_name_service' },
          ...
          { data: 'date_finished', name: 'date_finished' },
          { data: 'status_name', name: 'st.status_name' },
          { data: 'service_rating', name: 'service_rating' },
