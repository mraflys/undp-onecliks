...
<script type="text/javascript">
    function showTable() {
        ...
        $('#mytableRestore_filter input').unbind();
        $('#mytableRestore_filter input').bind('keyup', function(e) {
        ...
        if ($('#mytableRestore_filter .btn-search-dt').length == 0) {
            $('#mytableRestore_filter').append(
                '&nbsp;<button type="button" class="btn btn-sm btn-primary btn-search-dt"><i class="fa fa-search"></i></button>'
            );
            $('#mytableRestore_filter .btn-search-dt').on('click', function() {
                oTable.search($('#mytableRestore_filter input').val()).draw();
            });
        }
    }
