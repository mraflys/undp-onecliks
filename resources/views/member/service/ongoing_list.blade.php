...
<table class="table table-striped" id="mytableOngoing">
  <thead>
    <tr>
      ...
      <th class="sort" field="date_end_estimated" title="Order by Start Date" target="_ongoing">Est End Date</th>
      ...
      <th class="sort" field="cur_workflow" title="Order by Current Activity" target="_ongoing">Current Activity</th>
      <th class="sort" field="person_name_primary" title="Order by Current Primary PIC" target="_ongoing">Current PIC</th>
...
<script type="text/javascript">
   function showTableOngoing(){
      ...
      var oTable = $('#mytableOngoing').DataTable({
        ...
        "columns": [
          ...
          { data: 'date_start_actual', name: 'date_start_actual' },
          { data: 'date_end_estimated', name: 'date_end_estimated' },
          { data: 'requester', name: 'requester' },
          { data: 'status_name', name: 'status_name' },
          { data: 'workflow_name', name: 'workflow_name' },
          { data: 'user_name_primary', name: 'user_name_primary' },
  ...
  $(function(){
    showTableOngoing();
    $("#btnSearchOngoing").click(function(){ showTableOngoing(); });
  });
</script>