...
<script type="text/javascript">
   function showTableTracking(){
      ...
      var oTable = $('#mytableTracking').DataTable({
        ...
        "columns": [
          { data: 'transaction_code', name: 'tr_service.transaction_code' },
          { data: 'service_name', name: 'tr_service.service_name' },
          { data: 'date_transaction', name: 'tr_service.date_transaction' },
          { data: 'date_finished', name: 'tr_service.date_finished' },
          { data: 'person_name_buyer', name: 'tr_service.person_name_buyer' },
          { data: 'service_price', name: 'tr_service.service_price' },
          { data: 'status_name', name: 'ms_status.status_name' },
          { data: 'delay_duration', name: 'delay_duration', orderable: false, searchable: false },
          { data: 'service_rating', name: 'tr_service.service_rating' },
  ...
  $(function(){
    showTableTracking();
    $("#btnSearchTracking").click(function(){ showTableTracking(); });
  });
</script>