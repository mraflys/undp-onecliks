...
<script type="text/javascript">
  ...
  function showTable(){
      ...
      var oTable = $('#mytable').DataTable({
        ...
        "columns": [
          { data: 'invoice_no', name: 'tr_billing.invoice_no' },
          { data: 'invoice_no', name: 'tr_billing.invoice_no' },
          { data: 'agency_name', name: 'tr_billing.agency_name' },
          { data: 'amount_billing_local', name: 'amount_billing_local' },
          { data: 'amount_billing', name: 'amount_billing' },
          { data: 'date_created', name: 'tr_billing.date_created' },
          { data: 'date_payment', name: 'tr_billing_detail.date_payment' },
