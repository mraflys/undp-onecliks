...
<div style="float:right;">
  ...
  <table class="table">
    <tbody>
      <tr>
        <td class="td-judul">Invoice No </td>
...
<div style="text-align:center;margin-top:180px">
  ...
  <div style="width:100%">
    <table style="margin-left:100px;margin-right:100px;width:100%; text-align:center;border-collapse: collapse;border: 1px solid;">
      <thead>
        <tr >
    ...
    <div style="margin-left:100px;margin-right:100px;width:100%;text-align:right;margin-top:3px;margin-bottom:3px;">UNORE 1 USD = IDR {{number_format($detail->unore, 2)}}</div>
    <hr style="margin-left:100px;margin-right:100px;width:100%;">
    <div style="margin-left:100px;margin-right:100px;width:100%;margin-top:3px;margin-bottom:3px;">
      <table>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td>For payment made by bank transfer, please quote the invoice no. and send the payment advice to erlin.ferina@undp.org</td>
          </tr>
        </tbody>
      </table>
    </div>
    <br>
    <div style="text-align:left;margin-left:160px;margin-right:160px;width:100%;margin-top:3px;margin-bottom:3px;">
      ...
      <table>
        <tbody>
          <tr>
            ...
            <td style="width:170px"><b>81018-99999-888-008</b></td>
          </tr>
          <tr>
