...
<div class="kt-portlet">
  ...
  <?php 
    if (isset($detail) && !is_null($detail)) {
      $default_sequence = \App\WorkFlowDoc::get_latest_seq($detail->id_service_workflow); 
      $url = route('workflow_docs.update', [$detail->id_service_workflow_doc]);
      $method = 'PUT';
      ...
      $default_sequence = \App\WorkFlowDoc::get_latest_seq(\Request()->id_service_workflow); 
      $url = route('workflow_docs.store');
      $method = 'POST';
      $document_name = '';
  ...
  <form class="kt-form" action=" {{ $url }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="kt-portlet__body">
      ...
      <div class="form-group">
        ...
        <input type="text" name="document_name" class="form-control" value="<?=(!empty(old('document_name'))) ? old('document_name') : $document_name ;?>" placeholder="Enter document name">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" name="sequence" class="form-control" value="<?=(!empty(old('sequence'))) ? old('sequence') : $sequence ;?>" placeholder="Enter Sequence">
      </div>
      <div class="form-group">
    ...
    <div class="kt-portlet__foot">
      <div class="kt-form__actions">
        ...
        <a href="{{ route('workflow.docs', ['id_service_workflow' => $id_service_workflow]) }}" class="btn btn-secondary">Cancel</a>
      </div>
    </div>
  </form>
  <!--end::Form-->
