<html lang="en">
  ...
  <head>
    ...
    <link href="<?=$base_url_theme;?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?=asset('plugins/DataTables/Buttons-1.6.1/css/buttons.dataTables.min.css');?>" rel="stylesheet" type="text/css" />
    ...
    var generalDTButtons = function (orientation = 'landscape') {
                    return [{
                        ...
                        text: "<i class='fa fa-download'> Excel</i>",
                         init: function(api, node, config) {
                          ...
                          var base = '{{ route('myreport.coa.excel', ['date1' => 'dateone', 'date2' => 'datetwo', 'viewBy' => 'views']) }}';
      ...
      var generalDTLengths = [[ 10, 25, 50, -1 ],['10', '25', '50', 'All']];
  ...
  <!-- begin::Body -->
  <body style="background-image: url(<?=$base_url_theme;?>/assets/media/demos/demo4/header.jpg); background-position: center top; background-size: 100% 350px;" class="kt-page--fluid kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent">
 ...
 -->
    ...
    <script src="<?=$base_url_theme;?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
    ...
    <script src="<?=$base_url_theme;?>/assets/js/pages/crud/forms/widgets/bootstrap-datepicker.js" type="text/javascript"></script>
